...
for x in range(1000):
	...
	d=random.randrange(4200,4900)
	e=random.randrange(40,150)
	uga=f'Mozilla/5.0 (Linux; Android {a}; Pixel {b}) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{c}.0.{d}.{e} Mobile Safari/537.36'
	ugen2.append(uga)
...
def uaku():
try:
	prox= requests.get('https://api.proxyscrape.com/v2/?request=displayproxies&protocol=socks4&timeout=1000&country=all&ssl=all&anonymity=all').text
...
def menu(name,id):
	...
	print('')
	print('\x1b[1;93m[\x1b[1;92m▪︎\x1b[1;93m] \x1b[1;92mAuthor      : \x1b[1;93mDemias Syihab Aldino/Nolep/Brayen All Aouthor❤️ \33[m(\x1b[1;92mNolepXx/XzonXD/BrayennnXDDemias_Asyhiab\33[m)')
